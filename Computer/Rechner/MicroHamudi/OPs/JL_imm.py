...
class JL_imm(Instruction):
    """Class that represents 'JL imm'-Instruction"""
    ...
    def __str__(self):
        """String representation of 'JL imm'-instruction as 'xxxx cccc'"""
        return Opcodes.JL_imm.__str__() + "00" + " " + format_hex(self.imm, 4)
