...
class CALL_imm(Instruction):
    """Class that represents 'CALL imm'-Instruction"""
    ...
    def __str__(self):
        """String representation of 'CALL imm'-instruction as 'xxxx cccc'"""
        return Opcodes.CALL_imm.__str__() + "00" + " " + format_hex(self.imm, 4)
