...
class OR_RB_RA(Instruction):
    """Class that represents 'OR RB, RA'-Instruction"""
    ...
    def __str__(self):
        """String representation of 'OR RB, RA'-instruction as 'xxAB'"""
        return Opcodes.OR_RB_RA.__str__() + self.regA + self.regB
