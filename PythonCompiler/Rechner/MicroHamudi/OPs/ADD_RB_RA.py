...
class ADD_RB_RA(Instruction):
    """Class that represents 'ADD RB, RA'-Instruction"""
    ...
    def __str__(self):
        """String representation of 'ADD RB, RA'-instruction as 'xxAB'"""
        return Opcodes.ADD_RB_RA.__str__() + self.regA + self.regB
