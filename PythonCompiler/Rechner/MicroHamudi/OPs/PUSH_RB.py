...
class PUSH_RB(Instruction):
    """Class that represents 'PUSH RB'-Instruction"""
    ...
    def __str__(self):
        """String representation of 'PUSH RB'-instruction as 'xxxB'"""
        return Opcodes.PUSH_RB.__str__() + "0" + self.regB
