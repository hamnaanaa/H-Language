...
class CMP_RA_RB(Instruction):
    """Class that represents 'CMP RA, RB'-Instruction"""
    ...
    def __str__(self):
        """String representation of 'CMP RA, RB'-instruction as 'xxAB'"""
        return Opcodes.CMP_RA_RB.__str__() + self.regA + self.regB
