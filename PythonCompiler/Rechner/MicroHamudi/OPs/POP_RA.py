...
class POP_RA(Instruction):
    """Class that represents 'POP RA'-Instruction"""
    ...
    def __str__(self):
        """String representation of 'POP RA'-instruction as 'xxAx'"""
        return Opcodes.POP_RA.__str__() + self.regA + "0"
